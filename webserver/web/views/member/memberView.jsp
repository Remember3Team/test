   ...
   <div class="outer">
      ...
      <script>
      	...
      	function deleteMember(){
      		...
      		//하나의 폼태그로 두가지 이동을 할 수 있도록
      		//현재 update.me로 지정되어있는걸 deleteMember를 클릭하면 delete.me로 바뀌도록
      		//기존의 form 태그 경로는 회원정보 수정을 위한 urlmapping주소이므로 회원탈퇴는 경로를 수정해주자(attr이용)
      		
      		$("#updateForm").submit();
      		
      		//delteMemberServlet만들기
      	}
